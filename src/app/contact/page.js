        ...
        <div className=" contact-form flex flex-col items-end ">
          ...
          <div className="flex items-start w-[70%] h-full py-5">
            <form className=" text-black flex flex-col gap-2 w-full p-2">
              <input type="text" required placeholder="Full Name *" className=" p-3 rounded-md"/>
              <input type="email" required placeholder="Email Address*" className=" p-3 rounded-md"/>
              ...
              <textarea type="text" required placeholder="Comment" cols={5} rows={5} className=" p-3 rounded-md"/>
              <button type="submit" className="bg-red-500 text-white p-3 rounded-sm">Submit</button>
            </form>
          </div>
        </div>
